...
uint16_t Adafruit_ADS1015::readADC_SingleEnded(uint8_t channel) {
  ...
  /*write the config 2 times to the ADC to get the right measurements, dont know why*/
...
/**************************************************************************/
/*!
	@brief  convert from 12bit binary 2 complement in decimal
*/
/**************************************************************************/
uint16_t Adafruit_ADS1015::convertFrom12bit2KtoDec(uint16_t val) {
	if (val > 2047) {
		val = val << 4;
		val = ~val;
		val = val >> 4;
