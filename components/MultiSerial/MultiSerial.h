...
#define ARDUINO 10800   //wb mg 210819 to simulate the ARDUINO IDE
...
class MultiSerial : public Stream {
  ...
  public:
	...
	void resetRXfifo();	//wb Graf default: null
	void rxFIFOenable(); //wb Graf default: null
	void rxFIFOdisable(); //wb Graf default: null
	byte ReadRegister(byte); //wb Graf default: null
	byte WriteRegister(byte, byte); //wb Graf default: null
  ...
  private:
    ...
    byte msWriteRegister(byte, byte);
    void msWriteRegister(byte, byte[], byte);
	byte msReadRegister(byte);   
    void msSendSubAddr(byte);
};

extern MultiSerial* SC16IS752_CH_A; // wb Graf default: null
extern MultiSerial* SC16IS752_CH_B; // wb Graf default: null
