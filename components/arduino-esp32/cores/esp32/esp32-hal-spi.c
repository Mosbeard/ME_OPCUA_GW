...
spi_t * spiStartBus(uint8_t spi_num, uint32_t clockDiv, uint8_t dataMode, uint8_t bitOrder)
{
    ...
    if(spi_num == HSPI) {			/** DPORT_SPI_CLK_EN is deprecated, please use DPORT_SPI2_CLK_EN **/
        DPORT_SET_PERI_REG_MASK(DPORT_PERIP_CLK_EN_REG, DPORT_SPI2_CLK_EN);
        DPORT_CLEAR_PERI_REG_MASK(DPORT_PERIP_RST_EN_REG, DPORT_SPI2_RST);	/** DPORT_SPI_RST is deprecated, please use DPORT_SPI2_RST **/
    } else if(spi_num == VSPI) {	/** DPORT_SPI_CLK_EN_2 is deprecated, please use DPORT_SPI3_CLK_EN **/
        DPORT_SET_PERI_REG_MASK(DPORT_PERIP_CLK_EN_REG, DPORT_SPI3_CLK_EN);
        DPORT_CLEAR_PERI_REG_MASK(DPORT_PERIP_RST_EN_REG, DPORT_SPI3_RST);	/** DPORT_SPI_RST_2 is deprecated, please use DPORT_SPI3_RST **/
    } else {						/** DPORT_SPI_CLK_EN_1 is deprecated, please use DPORT_SPI01_CLK_EN **/
        DPORT_SET_PERI_REG_MASK(DPORT_PERIP_CLK_EN_REG, DPORT_SPI01_CLK_EN);
        DPORT_CLEAR_PERI_REG_MASK(DPORT_PERIP_RST_EN_REG, DPORT_SPI01_RST);	/** DPORT_SPI_RST_1 is deprecated, please use DPORT_SPI01_RST **/
    }
